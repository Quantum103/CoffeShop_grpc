...
const (
	CoffeShop_GetMenu_FullMethodName        = "/coffeeshop.CoffeShop/GetMenu"
	CoffeShop_PlaceOrder_FullMethodName     = "/coffeeshop.CoffeShop/PlaceOrder"
	CoffeShop_GetOrderStatus_FullMethodName = "/coffeeshop.CoffeShop/GetOrderStatus"
)
...
func RegisterCoffeShopServer(s grpc.ServiceRegistrar, srv CoffeShopServer) {
	// If the following call panics, it indicates UnimplementedCoffeShopServer was
