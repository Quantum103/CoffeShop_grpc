...
const file_coffee_shop_proto_rawDesc = "" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name2\xbf\x01\n" +
	"\tCoffeShop\x128\n" +
	...
	"\x0eGetOrderStatus\x12\x13.coffeeshop.Receipt\x1a\x17.coffeeshop.OrderStatus\"\x00B=Z;github.com/Quantum103/CoffeShop_grpc/proto/coffeeshop_protob\x06proto3"
...
var file_coffee_shop_proto_depIdxs = []int32{
	...
	0, // 2: coffeeshop.CoffeShop.GetMenu:input_type -> coffeeshop.MenuRequest
	1, // 3: coffeeshop.CoffeShop.PlaceOrder:input_type -> coffeeshop.Order
	2, // 4: coffeeshop.CoffeShop.GetOrderStatus:input_type -> coffeeshop.Receipt
	4, // 5: coffeeshop.CoffeShop.GetMenu:output_type -> coffeeshop.Menu
	2, // 6: coffeeshop.CoffeShop.PlaceOrder:output_type -> coffeeshop.Receipt
	3, // 7: coffeeshop.CoffeShop.GetOrderStatus:output_type -> coffeeshop.OrderStatus
